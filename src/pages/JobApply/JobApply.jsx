...
const JobApply = () => {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleApplyFormSubmit} className="flex justify-center items-center">
        <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-2xl border p-4">
          ...
          <input type="email" name="email" className="input" placeholder="Personal Email" />

          <label className="label">Contact Number</label>
          <input type="phone" name="contact" className="input" placeholder="Contact Number" />

          <label className="label">Description</label>
          <input type="text" name="description" className="input" placeholder="Your Description" />
